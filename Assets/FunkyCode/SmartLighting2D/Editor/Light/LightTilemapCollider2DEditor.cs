...
namespace FunkyCode
{
    ...
    public class LightTilemapCollider2DEditor : Editor
    {
        ...
        {
            var script = target as LightTilemapCollider2D;
            ...
            switch (script.mapType)
            {
                case MapType.UnityRectangle:
                    ...
                    script.shadowLayer = EditorGUILayout.Popup("Shadow Layer (Collider)", script.shadowLayer,
                    ...
                    script.rectangle.shadowOptimization =
                        EditorGUILayout.Toggle("Shadow Optimization", script.rectangle.shadowOptimization);
                    ...
                    script.maskLayer = EditorGUILayout.Popup("Mask Layer (Collider)", script.maskLayer,
                        Lighting2D.Profile.layers.colliderLayers.GetNames());
                ...
                case MapType.UnityIsometric:
                    ...
                    script.isometric.shadowType =
                        (ShadowType)EditorGUILayout.EnumPopup("Shadow Type", script.isometric.shadowType);
                    ...
                    script.isometric.maskType =
                        (MaskType)EditorGUILayout.EnumPopup("Mask Type", script.isometric.maskType);
                ...
                case MapType.UnityHexagon:
                    ...
                    script.hexagon.shadowType =
                        (ShadowType)EditorGUILayout.EnumPopup("Shadow Type", script.hexagon.shadowType);
 ...
 (SuperTilemapEditorSupport.TilemapCollider2D.ShadowType)EditorGUILayout.EnumPopup("Shadow Type", script.superTilemapEditor.shadowTypeSTE);
				
					script.shadowLayer =
 EditorGUILayout.Popup("Shadow Layer (Collider)", script.shadowLayer, Lighting2D.Profile.layers.colliderLayers.GetNames());
					
					script.superTilemapEditor.shadowOptimization =
 EditorGUILayout.Toggle("Shadow Optimization", script.superTilemapEditor.shadowOptimization);				
					
					EditorGUILayout.Space();

					script.superTilemapEditor.maskTypeSTE =
 (SuperTilemapEditorSupport.TilemapCollider2D.MaskType)EditorGUILayout.EnumPopup("Mask Type", script.superTilemapEditor.maskTypeSTE);
					...
					script.maskLayer =
 EditorGUILayout.Popup("Mask Layer (Collider)", script.maskLayer, Lighting2D.Profile.layers.colliderLayers.GetNames());
        ...
        private static void Update(LightTilemapCollider2D script)
        {
