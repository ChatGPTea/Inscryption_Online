...
namespace FunkyCode
{
    ...
    public class LightmapMaterials
    {
        ...
        {
            var material = materialPass.material;
            var rect = materialPass.rect;
            var isSceneView = materialPass.isSceneView;
            var rotation = materialPass.rotation;
            var texture = materialPass.texture;
            var color = materialPass.color;

            var isGameView = !isSceneView;
        ...
        public static void SetDayLight()
        {
            ...
            var alpha = Lighting2D.DayLightingSettings.ShadowColor.a;
