...
namespace FunkyCode
{
    ...
    public struct CameraSettings
    {
        ...
        [SerializeField] private CameraLightmap[] lightmaps;
        ...
        public int GetLayerId(int bufferId)
        {
            ...
            if (lightmap.overlayLayerType == CameraLightmap.OverlayLayerType.UnityLayer) return lightmap.renderLayerId;
            ...
            switch (cameraType)
            {
                ...
                case CameraType.SceneView:
                    ...
                    if (sceneView != null)
                    {
                        ...
                        if (!UnityEditor.SceneView.lastActiveSceneView.sceneLighting) camera = null;
