...
namespace FunkyCode.Lighting2DMaterial
{
    ...
    public class Shadow
    {
        private LightingMaterial alphaShadow;

        private LightingMaterial dayCPUShadow;

        private LightingMaterial depthDayShadow;

        private LightingMaterial fastShadow;
        private LightingMaterial legacyCPUShadow;
        private LightingMaterial legacyGPUShadow;
        private Sprite penumbraSprite;
        private Sprite penumbraSprite2;

        private LightingMaterial softDistanceShadow;

        private LightingMaterial softShadow;
        private LightingMaterial softShadowDefault;

        private LightingMaterial spriteProjection;
        private LightingMaterial spriteShadow;
        ...
        public Material GetLegacyGPUShadow()
        {
            if (legacyGPUShadow == null || legacyGPUShadow.Get() == null)
            {
                ...
                if (legacyGPUShadow.Get() != null) legacyGPUShadow.Get().mainTexture = GetPenumbraSprite().texture;
            }
        ...
        public Material GetLegacyCPUShadow()
        {
            if (legacyCPUShadow == null || legacyCPUShadow.Get() == null)
            {
                ...
                if (legacyCPUShadow.Get() != null) legacyCPUShadow.Get().mainTexture = GetPenumbraSprite().texture;
            }
        ...
        {
            if (penumbraSprite == null) penumbraSprite = Resources.Load<Sprite>("textures/penumbra");
        ...
        {
            if (penumbraSprite2 == null) penumbraSprite2 = Resources.Load<Sprite>("textures/penumbra2");
