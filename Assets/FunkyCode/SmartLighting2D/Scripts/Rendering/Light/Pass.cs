...
using FunkyCode.Rendering.Light.Sorting;
using UnityEngine;
    ...
    public class Pass
    {
        ...
        public bool Setup(Light2D light, LayerSetting setLayer)
        {
            ...
            if (materialNormalMap_PixelToLight != null)
            {
                ...
                {
                    materialNormalMap_PixelToLight.SetTexture("_SecTex",
                        light.Buffer.translucencyTexture.renderTexture);
            ...
            if (materialNormalMap_ObjectToLight != null)
            {
                if (light.translucentLayer > 0 && light.Buffer.translucencyTexture != null)
                {
                    materialNormalMap_ObjectToLight.SetTexture("_SecTex",
                        light.Buffer.translucencyTexture.renderTexture);
