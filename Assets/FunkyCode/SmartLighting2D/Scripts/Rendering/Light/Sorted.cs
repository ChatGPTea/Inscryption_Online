...
namespace FunkyCode.Rendering.Light
{
    public static class Sorted
    {
        ...
        {
            for (var i = 0; i < pass.sortPass.sortList.Count; i++)
            {
            ...
            if (collider.maskLayer == pass.layerID && pass.drawMask)
                switch (collider.mainShape.maskType)
                {
                    ...
                    case LightCollider2D.MaskType.BumpedSprite:
                        ...
                        material = collider.bumpMapMode.SelectMaterial(pass.materialNormalMap_PixelToLight,
        ...
        private static void DrawTile(LightTile tile, LightTilemapCollider2D tilemap, Pass pass)
        {
            ...
            if (tilemap.shadowLayer == pass.layerID && pass.drawShadows && !shadowsDisabled)
            {
                ShadowEngine.GetMaterial().SetPass(0);
            ...
            if (tilemap.maskLayer == pass.layerID && pass.drawMask && !masksDisabled)
            {
                GL.Begin(GL.QUADS);
                    ...
                    case MapType.UnityRectangle:
                        ...
                        switch (tilemap.rectangle.maskType)
                        {
                            ...
                            case MaskType.BumpedSprite:
                                ...
                                var material = tilemap.bumpMapMode.SelectMaterial(pass.materialNormalMap_PixelToLight,
                                    pass.materialNormalMap_ObjectToLight);
                    ...
                    case MapType.SuperTilemapEditor:
                        ...
                        switch (tilemap.superTilemapEditor.maskTypeSTE)
                        {
                            ...
                            case SuperTilemapEditorSupport.TilemapCollider.MaskType.BumpedSprite:
                                ...
                                var material = tilemap.bumpMapMode.SelectMaterial(pass.materialNormalMap_PixelToLight,
                                    pass.materialNormalMap_ObjectToLight);
                                SuperTilemapEditorSupport.Light.Mask.SpriteRenderer2D.BumpedSprite(pass.light, tilemap,
                                    material);
