...
namespace FunkyCode.Rendering.Lightmap
{
    ...
    {
        public static void Draw(Light2D light, Camera camera)
        {
        ...
        public static void DrawOcclusion(Light2D light, Camera camera)
        {
            if (light.Buffer == null)
                return;
        ...
        public static void DrawTranslucent(Light2D light, Camera camera)
        {
            if (light.Buffer == null)
                return;
