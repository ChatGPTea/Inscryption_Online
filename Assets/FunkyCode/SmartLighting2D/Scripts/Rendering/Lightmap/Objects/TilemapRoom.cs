...
namespace FunkyCode.Rendering.Lightmap
{
    ...
    {
        public static void Draw(LightTilemapRoom2D id, Camera camera)
        {
        ...
        public class Sprite
        {
            public static VirtualSpriteRenderer spriteRenderer = new();
            ...
            public static void Draw(Camera camera, LightTilemapRoom2D id, Material material)
            {
                ...
                var count = tilemapCollider.chunkManager.GetTiles(CameraTransform.GetWorldRect(camera));
                ...
                for (var i = 0; i < count; i++)
                {
                    ...
                    Universal.Sprite.Pass.Draw(tile.spriteMeshObject, spriteRenderer, tilePosition, tile.worldScale,
                        tile.worldRotation);
                }
