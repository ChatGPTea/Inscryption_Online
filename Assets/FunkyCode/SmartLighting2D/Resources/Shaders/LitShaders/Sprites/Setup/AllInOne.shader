    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                fixed3 lightSources = lerp(fixed3(1, 1, 1), SL2D_Pass_Black(2, IN.worldPos) + float3(1, 1, 1),
                        _LightMapLit);
                ...
                fixed3 lightingNormal = lerp(fixed3(1, 1, 1), SL2D_Bump_Pass(3, IN.worldPos, IN.texcoord),
                                             _OcclusionLit);
