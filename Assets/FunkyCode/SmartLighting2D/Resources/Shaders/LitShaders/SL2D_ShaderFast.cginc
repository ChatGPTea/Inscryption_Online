...
sampler2D _GameTexture5;
float4 _GameRect5;
float _GameRotation5;
sampler2D _GameTexture6;
float4 _GameRect6;
float _GameRotation6;
sampler2D _GameTexture7;
float4 _GameRect7;
float _GameRotation7;
sampler2D _GameTexture8;
float4 _GameRect8;
float _GameRotation8;
...
{
    return tex2Dproj(_GameTexture1, float4(lightmapUV.x, lightmapUV.y, 1, 1)) * (0.25 > ((lightmapUV.x - 0.5) * (
        lightmapUV.x - 0.5))) * (0.25 > ((lightmapUV.y - 0.5) * (lightmapUV.y - 0.5)));
}

float3 SL2D_FAST_PASS_2(float2 lightmapUV)
{
    return tex2Dproj(_GameTexture2, float4(lightmapUV.x, lightmapUV.y, 1, 1)) * (0.25 > ((lightmapUV.x - 0.5) * (
        lightmapUV.x - 0.5))) * (0.25 > ((lightmapUV.y - 0.5) * (lightmapUV.y - 0.5)));
}

float3 SL2D_FAST_PASS_3(float2 lightmapUV)
{
    return tex2Dproj(_GameTexture3, float4(lightmapUV.x, lightmapUV.y, 1, 1)) * (0.25 > ((lightmapUV.x - 0.5) * (
        lightmapUV.x - 0.5))) * (0.25 > ((lightmapUV.y - 0.5) * (lightmapUV.y - 0.5)));
}

float3 SL2D_FAST_PASS_4(float2 lightmapUV)
{
    return tex2Dproj(_GameTexture4, float4(lightmapUV.x, lightmapUV.y, 1, 1)) * (0.25 > ((lightmapUV.x - 0.5) * (
        lightmapUV.x - 0.5))) * (0.25 > ((lightmapUV.y - 0.5) * (lightmapUV.y - 0.5)));
}

float3 SL2D_FAST_PASS_5(float2 lightmapUV)
{
    return tex2Dproj(_GameTexture5, float4(lightmapUV.x, lightmapUV.y, 1, 1)) * (0.25 > ((lightmapUV.x - 0.5) * (
        lightmapUV.x - 0.5))) * (0.25 > ((lightmapUV.y - 0.5) * (lightmapUV.y - 0.5)));
}

float3 SL2D_FAST_PASS_6(float2 lightmapUV)
{
    return tex2Dproj(_GameTexture6, float4(lightmapUV.x, lightmapUV.y, 1, 1)) * (0.25 > ((lightmapUV.x - 0.5) * (
        lightmapUV.x - 0.5))) * (0.25 > ((lightmapUV.y - 0.5) * (lightmapUV.y - 0.5)));
}

float3 SL2D_FAST_PASS_7(float2 lightmapUV)
{
    return tex2Dproj(_GameTexture7, float4(lightmapUV.x, lightmapUV.y, 1, 1)) * (0.25 > ((lightmapUV.x - 0.5) * (
        lightmapUV.x - 0.5))) * (0.25 > ((lightmapUV.y - 0.5) * (lightmapUV.y - 0.5)));
}

float3 SL2D_FAST_PASS_8(float2 lightmapUV)
{
    return tex2Dproj(_GameTexture8, float4(lightmapUV.x, lightmapUV.y, 1, 1)) * (0.25 > ((lightmapUV.x - 0.5) * (
        lightmapUV.x - 0.5))) * (0.25 > ((lightmapUV.y - 0.5) * (lightmapUV.y - 0.5)));
}
