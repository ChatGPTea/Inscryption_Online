...
sampler2D _Render_GameTexture;
float4 _Render_GameRect;
float _Render_GameRotation;
sampler2D _Render_SceneTexture;
float4 _Render_SceneRect;
float _Render_SceneRotation;
