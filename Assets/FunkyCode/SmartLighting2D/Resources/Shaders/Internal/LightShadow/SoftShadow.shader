Shader "Light2D/Internal/Shadow/SoftShadow"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float EdgeDistance(float2 edgeLocal, float2 edgePosition, float coreSize, float lightSize, float2 pixelPos,
                                float state, float a, float b)
            {
            ...
            fixed4 frag(v2f i) : COLOR
            {
                ...
                float rightDistance1 = EdgeDistance(rightEdgeLocal, edgePosition, coreSize, lightSize, pixelPos, -1, 0,
                           1);
