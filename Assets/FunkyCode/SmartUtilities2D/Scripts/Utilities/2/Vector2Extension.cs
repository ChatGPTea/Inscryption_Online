...
namespace FunkyCode.Utilities
{
    public static class Vector2Extensions
    {
        ...
        public static Vector2 TransformToWorldXY(this Vector2 a, Transform transform)
        {
            ...
            var x = a.x * transform.lossyScale.x;
            var y = a.y * transform.lossyScale.y;
        ...
        {
            var dist = Mathf.Sqrt(a.x * a.x + a.y * a.y);
            var angle = Mathf.Atan2(a.y, a.x) + transform.eulerAngles.z * Mathf.Deg2Rad;
        ...
        {
            var dist = Mathf.Sqrt(a.x * a.x + a.y * a.y);
            var angle = Mathf.Atan2(a.y, a.x) - transform.eulerAngles.y * Mathf.Deg2Rad;
