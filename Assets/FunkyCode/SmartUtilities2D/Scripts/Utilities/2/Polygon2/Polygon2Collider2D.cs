...
namespace FunkyCode.Utilities
{
    public class Polygon2Collider2D
    {
        ...
        public static List<Polygon2> CreateFromCompositeCollider(CompositeCollider2D compositeCollider)
        {
            ...
            if (compositeCollider != null)
            {
                ...
                for (var i = 0; i < pathCount; i++)
                {
                    ...
                    var polygon = new Polygon2(pointsInPath);
        ...
        public static Polygon2 CreateFromEdgeCollider(EdgeCollider2D edgeCollider)
        {
        ...
        public static Polygon2 CreateFromCircleCollider(CircleCollider2D circleCollider, int pointsCount = -1)
        {
        ...
        public static Polygon2 CreateFromBoxCollider(BoxCollider2D boxCollider)
        {
        ...
        public static Polygon2 CreateFromCapsuleCollider(CapsuleCollider2D capsuleCollider, int pointsCount = -1)
        {
            if (pointsCount < 1) pointsCount = defaultCircleVerticesCount;
