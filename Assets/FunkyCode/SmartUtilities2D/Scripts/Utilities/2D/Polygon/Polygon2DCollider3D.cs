...
namespace FunkyCode.Utilities
{
    public class Polygon2DCollider3D
    {
        ...
        public static Polygon2D CreateFromBoxCollider(BoxCollider boxCollider)
        {
        ...
        public static List<Polygon2D> CreateFromMeshCollider(MeshCollider meshCollider)
        {
            var newPolygons = new List<Polygon2D>();
            ...
            var length = mesh.triangles.GetLength(0);
        ...
        public static Polygon2D CreateFromSphereCollider(SphereCollider sphereCollider, int pointsCount = -1)
        {
        ...
        public static Polygon2D CreateFromCapsuleCollider(CapsuleCollider capsuleCollider, int pointsCount = -1)
        {
            if (pointsCount < 1) pointsCount = defaultCircleVerticesCount;
