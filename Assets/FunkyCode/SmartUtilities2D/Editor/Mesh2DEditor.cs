...
namespace FunkyCode.Utilities
{
    ...
    public class Mesh2DEditor : Editor
    {
        ...
        {
            var script = target as Mesh2D;

            script.triangulation =
                (PolygonTriangulator2D.Triangulation)EditorGUILayout.EnumPopup("Triangulation Type",
                    script.triangulation);
            ...
            if (GUILayout.Button("Update Mesh")) script.Initialize();
        }
    }
}