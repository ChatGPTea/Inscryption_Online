...
namespace QFramework
{
    ...
    {
        private static AudioPlayerModel mAudioPlayerModel;

        internal static AudioPlayerModel AudioPlayerModel =>
            mAudioPlayerModel ?? (mAudioPlayerModel = Interface.GetModel<AudioPlayerModel>());

        protected override void Init()
        {
            RegisterModel(new AudioPlayerModel());
        }
        ...
        public static void ForEachAllSound(Action<AudioPlayer> operation)
        {
            ...
            foreach (var audioPlayer in soundPlayerInPlaying) pool.Add(audioPlayer);

            foreach (var audioPlayer in pool) operation(audioPlayer);
    ...
    {
        public Dictionary<string, List<AudioPlayer>> SoundPlayerInPlaying = new(30);
