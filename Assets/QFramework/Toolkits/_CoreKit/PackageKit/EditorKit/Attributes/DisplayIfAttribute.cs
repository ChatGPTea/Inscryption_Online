...
namespace MyBox.Internal
{
    ...
    public class ConditionalFieldAttributeDrawer : PropertyDrawer
    {
        ...
        public static bool IsConditionMatch(Object owner, DisplayIfData condition)
        {
        ...
        private static void LogFieldNotFound(Object owner, string field)
        {
            Debug.LogWarning($"Conditional Attribute is trying to check field {field} which is not present");
        }

        public static void LogMethodNotFound(Object owner, string method)
        {
            Debug.LogWarning(
