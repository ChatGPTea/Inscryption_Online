...
namespace QFramework
{
    ...
    {
        [NonSerialized] private EasyEvent<int, T> mCollectionAdd;
        ...
        [NonSerialized] private EasyEvent<int, int, T> mOnMove;

        [NonSerialized] private EasyEvent<int, T> mOnRemove;

        [NonSerialized] private EasyEvent<int, T, T> mOnReplace;
