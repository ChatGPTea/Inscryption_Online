...
namespace QFramework
{
    ...
    {
        private static readonly SimpleObjectPool<ActionTask> mActionTaskPool = new(
            () => new ActionTask(), task =>
            {
                task.Action = null;
        ...
        private readonly Dictionary<IAction, ActionTask> mExecutingActions = new();

        private readonly List<ActionTask> mPrepareExecutionActions = new();
